...
| `dashboard/api/README.md` | Dokumentasi API lokal |
| `directives/build_iku_dashboard_data.md` | SOP pembuatan dataset dan integrasi dashboard |
| `docs/dashboard_chart_rationale.md` | Alasan pemilihan chart dan deskripsi dashboard |
| `.tmp/iku_dataset/data_dictionary.md` | Kamus data hasil generate |
...
| Halaman IKU 1-11 | Selesai |
| Chart per IKU | Selesai |
| Dataset dummy CSV/XLSX | Selesai |
| SQL seed Laragon | Selesai |
| API chart/statistik | Selesai |
| API tabel | Selesai |
| Tabel data di website | Selesai |
| Pagination tabel | Selesai |
| Filter tahun | Selesai |
| Filter fakultas | Selesai |
| Filter prodi | Belum diterapkan |
| Autentikasi | Belum diterapkan |

## Lisensi dan Penggunaan

Proyek ini dibuat untuk kebutuhan pembelajaran, tugas visualisasi data, dan demonstrasi dashboard lokal. Semua data pada dataset dummy bersifat simulasi dan tidak mewakili data resmi institusi.
